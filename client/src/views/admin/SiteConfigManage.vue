    ...
    <a-card title="站点配置">
      ...
      <a-form :model="form" layout="vertical" style="max-width: 640px">
        ...
        <a-form-item label="品牌标语">
          <a-input v-model="form.footerSlogan" placeholder="如：链接开发者·赋能具身智能产业" />
        </a-form-item>
        <a-form-item label="联系我们标题">
          <a-input v-model="form.footerContactTitle" placeholder="如：联系我们" />
        </a-form-item>
        <a-form-item label="联系电话">
          <a-input v-model="form.footerContactPhone" placeholder="如：400-8078-999" />
        </a-form-item>
        <a-form-item label="联系地址">
          <a-input v-model="form.footerContactAddress" placeholder="如：江苏省苏州市吴中区友翔路18号" />
        </a-form-item>
        <a-form-item label="版权信息">
          <a-input v-model="form.footerCopyright" placeholder="如：© 2026 科沃斯八界 版权所有" />
        </a-form-item>
        <a-form-item label="备案号">
          <a-input v-model="form.footerIcp" placeholder="如：苏ICP备12345678号" />
        </a-form-item>
        <a-form-item>
